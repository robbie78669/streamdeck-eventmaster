...
function updateSettings() {
    ...
    if( activatePreset_presetNameElement != null){
        ...
        activatePreset.id = activatePreset_presetNameElement.options[selectedIndex].value;
        activatePreset.presetName = activatePreset_presetNameElement.options[selectedIndex].label;
    ...
    if( activateCue_cueNameElement != null) {
        ...
        activateCue.id = activateCue_cueNameElement.options[selectedIndex].value;
        activateCue.presetName = activateCue_cueNameElement.options[selectedIndex].label;
